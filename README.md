...
- Improve the API path handling so it works from any working directory.
- Add input validation for unknown manufacturers, models, and categories.
- Add automated tests for preprocessing and prediction.
- Improve model tuning and compare multiple regression algorithms.
- Deploy the API and frontend using a cloud platform.

## License

This project currently does not specify a license. Add a license file if you want to define how others may use, modify, and distribute the project.
